  ...
  <table class="styled-table" id="table_id">
    ...
    <tbody id="tbody_table_record">
      ...
      foreach ($pdo->query($sql) as $row) {
        ...
        echo '<td class="bdr">' . $row['soil_moisture'] . '</td>';
        echo '<td class="bdr">' . $row['status_soil'] . '</td>';
        echo '<td class="bdr">' . $row['light_level'] . '</td>';
        echo '<td class="bdr">' . $row['status_light'] . '</td>';
        echo '<td class="bdr">' . $row['status_read_sensor_dht11'] . '</td>';
        echo '<td class="bdr">' . $row['LED_01'] . '</td>';
        echo '<td class="bdr">' . $row['LED_02'] . '</td>';
        echo '<td class="bdr">' . $row['LED_03'] . '</td>';
