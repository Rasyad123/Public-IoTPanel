...
if (isset($_POST['login'])) {
  ...
  if (password_verify($pass, $cariuser['password'])) {
      ...
      if ($cariuser) {
          echo "<script>alert('Anda berhasil login sebagai " . $cariuser['username'] . "');window.location='test2.php'</script>";
      } else {
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="home.php" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder">Rasyad Panel</span>
              </a>
            </div>
            <!-- /Logo -->
            <form method="POST">
