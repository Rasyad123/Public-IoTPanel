...
if (!empty($_POST)) {
  ...
  // Ganti dengan nama tabel sebenarnya (yang update)
  ...
  foreach ($pdo->query($sql) as $row) {
    ...
    $myObj->soil_moisture = $row['soil_moisture'];
    $myObj->status_soil = $row['status_soil'];
    $myObj->light_level = $row['light_level'];
    $myObj->status_light = $row['status_light'];
    ...
    $myObj->auto_mode = (int)$row['auto_mode'];
